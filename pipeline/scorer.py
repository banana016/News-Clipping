...
summary(핵심 내용)는 기사에 직접 나온 사실만 2문장 내외로, 존댓말(-습니다/-입니다체)로
쓰세요.

interpretation(전략 포인트)은 왜 중요한지를 1문장으로 압축하되, "해석하자면",
"~읽힌다", "~보인다", "~시사점이다"처럼 이게 당신의 판단·해석이라는 티가 나는
표현은 쓰지 마세요. 대신 summary에 자연스럽게 이어지는 사실 설명처럼 담백한
서술형 존댓말 문장으로 쓰세요 (예: "핵심은 A에서 B로 전략축을 옮긴 부분입니다"는
좋고, "A에서 B로 전략축을 옮긴 것으로 읽힙니다"는 안 됩니다). summary와
interpretation을 이어 읽었을 때 하나의 짧고 자연스러운 요약문처럼 읽혀야 합니다.

application(실무 적용 아이디어)은 1-2문장. 기사에 없는 사실을 추측해서 추가하지
마세요.
